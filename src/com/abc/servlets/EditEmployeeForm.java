...
public class EditEmployeeForm extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<form action='EditEmployee method='post' style='width:300px'>");
		out.print("<div class='form-group'>");
		out.print("<input type='hidden' name='id' value='"+bean.getEid()+"'/>");
		out.print("<label for='name1'>Name</label>");
		out.print("<input type='text' class='form-control' value='"+bean.getEname()+"' name='name' id='name1' placeholder='Name'/>");
		out.print("</div>");
//		out.print("<div class='form-group'>");
